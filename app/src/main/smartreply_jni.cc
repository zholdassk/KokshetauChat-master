...
Java_com.akmola.android.kokshetauchat_smartreply_SmartReplyClient_loadJNI(
...
Java_com.akmola.android.kokshetauchat_smartreply_SmartReplyClient_predictJNI(
  ...
  jclass smart_reply_class = CheckNotNull(
      env, env->FindClass("com.akmola.android.kokshetauchat/smartreply/SmartReply"));
...
Java_com.akmola.android.kokshetauchat_smartreply_SmartReplyClient_unloadJNI(
