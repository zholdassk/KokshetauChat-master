...
public class LoginActivity extends AppCompatActivity {
    ...
    public void clickLogin(View view) {
        ...
        if (validate(username, passwordString)) {
            ...
            Toast.makeText(this, "Пустой email или пароль!", Toast.LENGTH_SHORT).show();
        }
    }
                        ...
                        if (!task.isSuccessful()) {
                            new LovelyInfoDialog(LoginActivity.this) {
                                ...
                                public LovelyInfoDialog setConfirmButtonText(String text) {
                                    ...
                                    .setTitle("Не удалось зарегистрироваться!")
                                    .setMessage("Email существует или подключение к интернету отсутствует.")
                                    .setConfirmButtonText("Ок")
                                    .setCancelable(false)
                                    .show();
                        } else {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            new LovelyInfoDialog(LoginActivity.this) {
                                ...
                                public LovelyInfoDialog setConfirmButtonText(String text) {
                                    ...
                                    .setTitle("Не удается войти!")
                                    .setMessage("Пожалуйста проверьте правильность написания email и пароля или подключение к интернету отсутствует.")
                                    .setCancelable(false)
                                    .setConfirmButtonText("Ок")
                                    .show();
                        } else {
    ...
    private void initNewUserInfo(FirebaseUser user, String name, String token) {
        ...
        newUser.setBioText("Привет всем! Я использую Кокшетау Чат.");
