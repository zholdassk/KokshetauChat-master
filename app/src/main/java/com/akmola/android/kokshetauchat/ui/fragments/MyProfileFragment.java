package com.akmola.android.kokshetauchat.ui.fragments;
...
import com.akmola.android.kokshetauchat.models.ProfileItem;
import com.akmola.android.kokshetauchat.models.User;
import com.akmola.android.kokshetauchat.ui.activities.LoginActivity;
import com.akmola.android.kokshetauchat.utils.Constants;
import com.akmola.android.kokshetauchat.utils.ImageUtil;
    ...
    private ValueEventListener userListener = new ValueEventListener() {
        ...
        *If there is no data, the snapshot returned is null.*/
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            myAccount.setBioText(dataSnapshot.child("bioText").getValue(String.class));
    ...
    private View.OnClickListener onProfileImageClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            new AlertDialog.Builder(context)
                    ...
                    .setMessage("Вы уверены что хотите добавить или изменить фото своего профиля?")
        ...
        if (requestCode == PICK_IMAGE && resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                waitingDialog.setCancelable(false)
                        .setTitle("Фото профиля загружается...")
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    new LovelyInfoDialog(context)
                                            .setTopColorRes(R.color.colorPrimary)
                                            .setTitle("Загрузка")
                                            .setMessage("Фото профиля успешно загружено!")
                                            .show();
                                }
                            }
                        })
                ...
                .setPositiveButton(R.string.logout, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                            ...
                            Toast.makeText(getActivity(), "Вы успешно вышли из Кокшетау Чат!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(getActivity(), LoginActivity.class));
                        } else {
                            Toast.makeText(getActivity(), "Вы не вошли в аккаунт!", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
            ...
            ((RelativeLayout) holder.label.getParent()).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (profileItem.getLabel().equals(Constants.USERNAME_LABEL)) {
                        ...
                        new AlertDialog.Builder(context)
                                .setTitle("Обновить имя и фамилию")
                    ...
                    if (profileItem.getLabel().equals(Constants.RESETPASS_LABEL)) {
                        new AlertDialog.Builder(context)
                                ...
                                .setMessage("Вы уверены, что хотите изменить пароль?")
                                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        resetPassword();
                    ...
                    .setPositiveButton("Ок", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (pwdOld.length() > 0 && validate(pwd, repeatedPwd)) {
                                ...
                                Toast.makeText(getContext(), "Пустые поля или пароли не совпадают или слабый пароль!", Toast.LENGTH_SHORT).show();
                            }
