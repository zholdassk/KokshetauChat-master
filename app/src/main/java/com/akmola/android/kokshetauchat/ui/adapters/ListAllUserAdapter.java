package com.akmola.android.kokshetauchat.ui.adapters;
...
import com.akmola.android.kokshetauchat.ui.activities.AllUsersActivity;
        ...
        if (friendsId.contains(user.getUid())) {
            ...
            ((ItemAllUserViewHolder) holder).actionBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new android.app.AlertDialog.Builder(context)
                            ...
                            .setMessage("Вы уверены, что хотите удалить из друзей " + user.getName() + "?")
            ...
            ((ItemAllUserViewHolder) holder).actionBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new android.app.AlertDialog.Builder(context)
                            .setTitle("Требуется подтверждение")
                            .setMessage("Вы уверены, что хотите отменить этот запрос на добавления в друзья " + user.getName() + "?")
                            .setPositiveButton("ДА", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
            ...
            ((ItemAllUserViewHolder) holder).actionBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final CharSequence[] options = {"Добавить", "Отмена", "Не сейчас"};
                    AlertDialog.Builder builder = new AlertDialog.Builder(context);
                    builder.setTitle("Получен запрос на дружбу!");
                    builder.setIcon(R.drawable.ic_add_friend);
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if (options[i].equals("Добавить")) {
                                ...
                                ((ItemAllUserViewHolder) holder).actionBtn.setText(R.string.delete_friend);
                            } else if (options[i].equals("Отмена")) {
                                cancelFriendRequestMethod(user.getUid());
                                Intent intentRemoved = new Intent(AllUsersActivity.ACTION_UPDATE_LIST);
