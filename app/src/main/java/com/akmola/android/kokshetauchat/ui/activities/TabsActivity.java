...
import com.akmola.android.kokshetauchat.ui.adapters.TabsPageAdapter;
import com.akmola.android.kokshetauchat.ui.fragments.FriendsFragment;
import com.akmola.android.kokshetauchat.ui.fragments.MyProfileFragment;
import com.akmola.android.kokshetauchat.ui.fragments.NotificationFragment;
...
public class TabsActivity extends AppCompatActivity {
    ...
    public static String STR_CHAT_FRAGMENT = "ЧАТЫ";
    public static String STR_GROUP_FRAGMENT = "ГРУППЫ";
    public static String STR_NOTIF_FRAGMENT = "УВЕДОМЛЕНИЯ";
    public static String STR_PROFILE_FRAGMENT = "ПРОФИЛЬ";
                ...
                .setPositiveButton(R.string.logout, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                            ...
                            Toast.makeText(TabsActivity.this, "Вы успешно вышли из Кокшетау Чат!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(TabsActivity.this, LoginActivity.class));
                        } else {
                            Toast.makeText(TabsActivity.this, "Вы не вошли в аккаунт!", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
